...
def auto_seed_dbms():
    print("🚀 Initializing DBMS 200-Question Target Seeder Engine...")
    
    subject, _ = Subject.objects.get_or_create(name="DBMS")
    total_questions_added = 0
    
    # Grab the nested DBMS questions from the data pool
    ...
    print(f"\n🎉 Success! Added {total_questions_added} synced DBMS questions into the database.")
