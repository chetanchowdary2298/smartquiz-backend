...
def auto_seed_c():
    print("🚀 Initializing C Programming 200-Question Target Seeder Engine...")
    
    subject, _ = Subject.objects.get_or_create(name="C Programming")
    total_questions_added = 0
    
    # Grab the nested C Programming questions from the data pool
    c_questions = DATA_POOL.get("C Programming", {})

    for topic_name, base_questions in c_questions.items():
    ...
    print(f"\n🎉 Success! Added {total_questions_added} synced C Programming questions into the database.")
