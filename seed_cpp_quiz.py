...
def auto_seed_cpp():
    print("🚀 Initializing C++ 200-Question Target Seeder Engine...")
    
    subject, _ = Subject.objects.get_or_create(name="C++")
    total_questions_added = 0
    
    # Grab the nested C++ questions from the data pool
    cpp_questions = DATA_POOL.get("C++", {})

    for topic_name, base_questions in cpp_questions.items():
    ...
    print(f"\n🎉 Success! Added {total_questions_added} synced C++ questions into the database.")
