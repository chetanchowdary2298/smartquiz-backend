...
def auto_seed_java():
    print("🚀 Initializing Java 200-Question Target Seeder Engine...")
    
    subject, _ = Subject.objects.get_or_create(name="Java")
    total_questions_added = 0
    
    # Grab the nested Java questions from the data pool
    java_questions = DATA_POOL.get("Java", {})

    for topic_name, base_questions in java_questions.items():
    ...
    print(f"\n🎉 Success! Added {total_questions_added} synced Java questions into the database.")
